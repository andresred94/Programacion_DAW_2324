...
public class Vivienda extends Construccion implements Serializable, Comparable <Vivienda>{
...
//		return "tipo_inmueble:"+getTipo_inmueble()+",inmueble:"+getTipo_Cons()+",tipo_vivienda:"+tipoVvnd+",estado:"+super.getEstadoCons()+",ubicación:" +super.getUbicacion()+ ",tamaño:" +super.getTamanio()+",n_habitaciones:"+numerohab+",precio_total:"+super.getPrecioTdecimal()+",n_pisos:"+numeropisos;
		return String.format("%ntipo_inmueble:%s,inmueble:%s,tipo_vivienda:%s,estado:%s,ubicación:%s,tamaño:%.2f,n_habitaciones:%d,precio_total:%.2f,n_pisos:%d%n",getTipo_inmueble(),getTipo_Cons(),tipoVvnd,super.getEstadoCons(),super.getUbicacion(),super.getTamanio(),numerohab,super.getPrecioTdecimal(),numeropisos);
	}
